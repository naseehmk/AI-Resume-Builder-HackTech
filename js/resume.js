...
{
  "summary": "A compelling 3-4 sentence professional summary for the resume",
  "suggestions": [
...
Write the summary in first person. Make it ATS-friendly, professional, and tailored to the ${jobRole} role.
For suggestions, give practical tips to improve this specific resume.
    `;
...
function downloadPDF() {
  ...
  const printContent = `
    ...
    <head>
      ...
      <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .resume-head h1 { font-family: 'Space Grotesk', sans-serif; font-size: 1.6rem; font-weight: 700; letter-spacing: -0.02em; }
    ...
    <body>
      ${document.getElementById('resumeOutput').innerHTML.replace(/<div class="ai-suggestions"[\s\S]*?<\/div>\s*<\/div>/g, '')}
    </body>
    </html>
  `;
